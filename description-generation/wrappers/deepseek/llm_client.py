...
# LLMClientWrapper for DeepSeek (OpenAI-compatible API).
...
class LLMClientWrapper:
    def __init__(
        ...
        self.api_key = llm_api_key or os.getenv("DEEPSEEK_API_KEY")
    ...
    def _write_log(self, entry: dict):
        ...
        fname = f"deepseek_{log_type}_{repo_slug}_pr{prn}_{ts}.json"
        try:
